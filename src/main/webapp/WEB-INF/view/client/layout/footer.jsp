    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-3">
                ...
                <p class="mb-1 text-secondary">Tư vấn mua hàng: <strong class="text-white">1900 6750</strong></p>
                <p class="mb-1 text-secondary">Góp ý, khiếu nại: <strong class="text-white">1900 6750</strong></p>
            </div>
            <div class="col-lg-3">
                <h6 class="fw-bold mb-3">Thông tin và chính sách</h6>
                <ul class="list-unstyled text-secondary fs-sm">
                    <li><a href="#" class="text-reset text-decoration-none">Giới thiệu Jake Shop</a></li>
            ...
            <div class="col-lg-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <span class="badge bg-white p-2 text-dark">VISA</span>
                    <span class="badge bg-white p-2 text-dark">MOMO</span>
                    <span class="badge bg-white p-2 text-dark">VNPAY</span>
                </div>
            </div>
        </div>
        <hr class="my-4 border-secondary">
        <p class="text-center text-secondary small">© Bản quyền thuộc về Jake Shop. Cung cấp bởi Sapo</p>
    </div>
</footer>